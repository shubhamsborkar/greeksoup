...
- Optional: an account with a broker that lets a program read it, which brokers call an API. The desk connects to Alpaca, Angel One, Charles Schwab, Dhan, Groww, ICICI Direct, Interactive Brokers, Longbridge, Questrade, Saxo Bank, tastytrade, Tradier, Trading 212, Upstox and Zerodha as it comes, read-only, with what each hands out from its own dashboard; any other broker with an API is one file your agent writes from its documentation. Most of them also give the desk live prices for your watchlist through the same connection; where one does not yet (Charles Schwab, Interactive Brokers, Longbridge and Trading 212), the free feed prices it, and Settings says for each what your agent can add. Without one, you keep your holdings by hand on Desk · Book with Yahoo symbols, and the US desk and every intelligence screen still work.
...
So a reader in the US picks Alpaca, Charles Schwab, Interactive Brokers, Tradier or tastytrade and has both desks; a reader in Europe picks Saxo Bank, Trading 212 or Interactive Brokers; a reader in Canada picks Questrade; a reader in Hong Kong or Singapore picks Longbridge or Saxo Bank; a reader in India picks any of the five Indian brokers; a reader in Australia has the agent write the file for an ASX broker, or keeps the book by hand while it is written.
...
- **Commodities**: 54 commodities in seven groups, from crude and copper to rubber, coking coal, palm oil, tea and five currency pairs (the dollar against the rupee, the yuan and the yen, and the euro and the pound against the dollar), each with the level, five change windows and the distance from its five-year high. Click one and it shows the industries a rise squeezes and the industries it helps, the same in any country, and under each industry the listed names you have mapped to it, priced live, with the raw-material share from their own filings. A names-under-pressure panel adds up every commodity a name sits on and ranks who is squeezed and who is helped this month. It ships with the US names; you add your own market in one file (below). With India as the home market six cards carry the benchmark mandi's price under the global one (Indore wheat and soybean, Davangere maize, Raichur kapas, Muzaffarnagar gur) and Kottayam RSS4 from the Rubber Board, keyless.
...
- **Any ticker**: Cmd+K, type a symbol: chart, valuation, quality, estimates, insiders, dividends, news, and with a feed key six years of statements, ratios, segments, peers and a DCF sandbox. When greeksoup.ai carries the name, the page's top corner links its public-record page there, in a new tab.
- **greeksoup.ai**, the sidebar's last entry before Settings: the website's stock pages, the same public record the desk reads laid out per name for the S&P 500 and the NIFTY 100, facts only, in a new tab. Hide it like any other entry if you never use it.
