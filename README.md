...
- **greeksoup.ai**, the sidebar's last entry before Settings: the website's stock pages, the same public record the desk reads laid out per name for the S&P 100 and the NIFTY 100, facts only, in a new tab. Hide it like any other entry if you never use it.
