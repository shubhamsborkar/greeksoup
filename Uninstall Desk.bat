...
echo   --------------------
rem Remove the start-at-login entry only when it starts THIS folder's desk. Somebody
rem with a second copy of the desk keeps that copy's entry exactly as it is.
